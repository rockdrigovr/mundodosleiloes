...
import 'consultor_contato3_model.dart';
export 'consultor_contato3_model.dart';

class ConsultorContato3Widget extends StatefulWidget {
  const ConsultorContato3Widget({super.key});

  @override
  State<ConsultorContato3Widget> createState() =>
      _ConsultorContato3WidgetState();
}

class _ConsultorContato3WidgetState extends State<ConsultorContato3Widget>
    with TickerProviderStateMixin {
  late ConsultorContato3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConsultorContato3Model());
