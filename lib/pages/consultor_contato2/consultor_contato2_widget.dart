...
import 'consultor_contato2_model.dart';
export 'consultor_contato2_model.dart';

class ConsultorContato2Widget extends StatefulWidget {
  const ConsultorContato2Widget({super.key});

  @override
  State<ConsultorContato2Widget> createState() =>
      _ConsultorContato2WidgetState();
}

class _ConsultorContato2WidgetState extends State<ConsultorContato2Widget>
    with TickerProviderStateMixin {
  late ConsultorContato2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConsultorContato2Model());
